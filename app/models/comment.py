...
from app.models.base_model import ArrayType, Base, CustomPydanticBaseModel, ModelBaseInfoDto
...
class CommentDto:
    ...
    class WithModelBaseInfo(ModelBaseInfoDto, Base):
        ...
        reply_count: int = Field(default=None, description="reply_count", example=1)
